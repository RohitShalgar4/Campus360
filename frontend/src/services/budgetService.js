...
export const addExpense = async (formData) => {
  try {
    ...
    console.error("Error in addExpense service:", {
...
export const getExpenseById = async (id) => {
  try {
    ...
    console.error(
      "Error in getExpenseById service:",
...
export const updateExpense = async (id, formData) => {
  try {
    ...
    console.error(
      "Error in updateExpense service:",
      error.response?.data || error.message
    );
    throw error.response?.data || { message: error.message };
  }
...
export const deleteExpense = async (id) => {
  try {
    ...
    console.error(
      "Error in deleteExpense service:",
      error.response?.data || error.message
    );
    throw error.response?.data || { message: error.message };
  }
      ...
      if (categoryData && categoryData.data) {
        categoryData.data.forEach((category) => {
          if (categories[category.name]) {
            ...
            categories[category.name].remaining =
              category.allocated - categories[category.name].spent;
          }
        });
      }
    }
