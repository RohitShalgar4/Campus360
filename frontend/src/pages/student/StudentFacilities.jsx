...
function StudentFacilities() {
  ...
  const handleBookingRequest = (facilityId, slot) => {
    console.log(`Booking requested for facility ${facilityId} at ${slot}`);
    // Add logic to handle booking requests
  };
                        ...
                        {day.slots.map((slot) => (
                          ...
                          >
                            ...
                            <button
                              ...
                              onClick={() => handleBookingRequest(facility.id, slot)}
                            >
                              Request Booking
                            </button>
                          </div>
